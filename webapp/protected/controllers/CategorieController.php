...
class CategorieController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Categorie']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->categorieId));
		}
	...
	public function actionAdmin()
	{
        ...
        public function actionFetchSublist($id)
        {
            $categorii=  Categorie::model()->findAll('parentId='.$id);
            $dropdown='';
            if(!empty($categorii))
                foreach($categorii as $categorie)
                {
                    $dropdown.='<option value="'.$categorie->categorieId.'">'.$categorie->nume.'</option>';
                }
            if($dropdown=='')
